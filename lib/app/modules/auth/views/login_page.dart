  ...
  import 'package:ziya_attend/app/modules/auth/components/custom_btn.dart';
  ...
  class LoginPage extends StatelessWidget {
    ...
    Future<void> _login(BuildContext context) async {
      ...
      try {
        ...
        final userDoc = await authController.firestore.collection('users').doc(authController.currentUser?.uid).get();
